...
CREATE TABLE `marcas` (
  ...
  `proveedor_marca` int DEFAULT NULL,
  PRIMARY KEY (`id_marcas`),
  KEY `id_proveedor_idx` (`proveedor_marca`),
  CONSTRAINT `id_proveedor` FOREIGN KEY (`proveedor_marca`) REFERENCES `proveedor` (`id_proveedor`)
...
INSERT INTO `marcas` VALUES (1,'Bimbo',1),(2,'Coca-Cola',2),(3,'La Serenisima',3),(4,'Natura',4),(5,'Oreo',5),(6,'Paladini',6),(7,'Pantene',7),(8,'Paty',8),(9,'Sin marca',9),(10,'Skip',10);
...
INSERT INTO `producto` VALUES (1,'gaseosa cola',850.5,1000,2,2,2.5,4,'coca.webp',10,1),(2,'yogurt ',270,495,3,6,190,2,'yogurt.webp',5,1),(3,'milanesa nalga',4200,250,9,3,1,3,'milanesa.webp',NULL,1),(4,'galletas',333.4,1090,5,10,118,2,'oreo.webp',25,1),(5,'bananas',639,290,9,11,1,3,'banana.webp',13,1),(6,'mayonesa',408,1500,4,1,500,1,'mayonesa.webp',2,1),(7,'jamon cocido',4912.92,300,6,5,1,3,'jamon.jpg',NULL,1),(8,'shampoo',1755.01,1995,7,9,400,5,'pantene.webp',5,1),(9,'hamburguesa carne',739.03,2999,8,4,274,2,'paty.webp',5,1),(10,'jabon ropa',2890.08,2000,10,7,3,4,'jabon.webp',NULL,1),(11,'pan blanco',845.55,1000,1,8,550,2,'pan.webp',NULL,1),(16,'Sprite Lima Limon',828,197,2,2,2,4,'sprite.webp',15,1),(17,'Fanta Naranja',828,999,2,2,2,4,'fanta.webp',8,1);
...
-- Dump completed on 2023-10-31 21:38:20
